...
|--|--|--|
|[Neural Turing Machines](https://arxiv.org/pdf/1410.5401)|Arxiv 2014|The key idea is to randomly drop units during training, which prevents units from co-adapting too much.|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzU2OTM0ODY5XX0=
-->
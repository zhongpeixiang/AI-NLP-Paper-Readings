...
|--|--|--|
|[GloVe: Global Vectors for Word Representation](https://arxiv.org/pdf/1410.5401)|Arxiv 2014|Coupling neural networks to external memory resources, which they can interact with by attentional processes.|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1Nzc3NDczM119
-->